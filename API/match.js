...
router.post('/createMatch', (request, response) => {
    ...
    connection.execute('INSERT INTO match_ (match_state_id, match_turn_player_id) VALUES (?,?)',
        [1, playerID],
        function (err, results, fields) {
            if (err){
                ...
                connection.execute('INSERT INTO testingdb.player_match (pm_player1_id, pm_match_id) VALUES (?,?)',
                [playerID, match_id],
                function (err, results, fields) {
                    if (err){
...
// neste ficheiro: conseguir encontrar e criar uma match, se nao houver um player 1 entao criar um, se sim entao criar um player 2